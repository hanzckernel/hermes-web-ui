<!--
agent_page_id: settings-and-security
...
> Agent summary: 显示、agent、memory、privacy、session、voice、账号、安全相关设置。

## What it is

显示、agent、memory、privacy、session、voice、账号、安全相关设置。 本页面把可见 UI、route、源码锚点和截图放在一起，便于人审查，也便于 agent 快速定位。
...
![settings account modal](assets/screenshots/settings-account-modal.png)

<sub>settings account modal — isolated latest-main product/manual screenshot; no private Han data.</sub>
