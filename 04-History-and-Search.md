<!--
agent_page_id: history-and-search
...
> Agent summary: 历史会话浏览、搜索、深链打开和 Chat/History 范围差异。

## What it is

历史会话浏览、搜索、深链打开和 Chat/History 范围差异。 本页面把可见 UI、route、源码锚点和截图放在一起，便于人审查，也便于 agent 快速定位。
...
![history sessions](assets/screenshots/history-sessions.png)

<sub>history sessions — isolated latest-main product/manual screenshot; no private Han data.</sub>

![global search modal](assets/screenshots/global-search-modal.png)

<sub>global search modal — isolated latest-main product/manual screenshot; no private Han data.</sub>
