    ...
    >
      ...
      <template v-if="p.key === 'feishu'">
        ...
        <SettingRow :label="t('platform.encryptKey')" :hint="t('platform.encryptKeyHint')">
          <NInput :value="credentialDraft('feishu').extra?.encrypt_key || ''" :loading="isSavingPlatform('feishu')" clearable size="small" class="input-lg" placeholder="Encrypt Key" @update:value="v => setCredentialDraft('feishu', { extra: { ...credentialDraft('feishu').extra, encrypt_key: v } })" />
        </SettingRow>
        <SettingRow :label="t('platform.verificationToken')" :hint="t('platform.verificationTokenHint')">
          <NInput :value="credentialDraft('feishu').extra?.verification_token || ''" :loading="isSavingPlatform('feishu')" clearable size="small" class="input-lg" placeholder="Verification Token" @update:value="v => setCredentialDraft('feishu', { extra: { ...credentialDraft('feishu').extra, verification_token: v } })" />
        </SettingRow>
        <SettingRow :label="t('platform.requireMention')" :hint="t('platform.requireMentionGroup')">
