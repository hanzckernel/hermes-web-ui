...
> Agent summary: 安装、启动、认证、健康检查和第一次打开 Hermes Web UI。

## What it is

安装、启动、认证、健康检查和第一次打开 Hermes Web UI。 本页面把可见 UI、route、源码锚点和截图放在一起，便于人审查，也便于 agent 快速定位。
