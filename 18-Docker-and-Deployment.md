<!--
agent_page_id: docker-and-deployment
...
> Agent summary: npm、setup script、Docker Compose、环境变量、持久化目录和 health check。

## What it is

npm、setup script、Docker Compose、环境变量、持久化目录和 health check。 本页面把可见 UI、route、源码锚点和截图放在一起，便于人审查，也便于 agent 快速定位。
...
<sub>startup login — isolated latest-main product/manual screenshot; no private Han data.</sub>
